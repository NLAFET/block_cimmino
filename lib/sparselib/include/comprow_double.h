...
/*******************************/
       ...
       const VECTOR_double      val(const MV_VecIndex &I) const { return val_(I); }
       const VECTOR_int         row_ptr(const MV_VecIndex &I) const { return rowptr_(I); }
       const VECTOR_int         col_ind(const MV_VecIndex &I) const { return colind_(I);}

       VECTOR_double t_val() { return val_ ;}
       VECTOR_int t_row() { return rowptr_ ;}
       VECTOR_int t_col() { return colind_ ;}

       double *val_ptr() {double *p = val_.ptr(); return p; }
       int *rowptr_ptr() {int *p = rowptr_.ptr(); return p; }
       int *colind_ptr() {int *p = colind_.ptr(); return p; }
       
       const VECTOR_double tc_val() const { return val_ ;}
       const VECTOR_int tc_row() const { return rowptr_ ;}
       const VECTOR_int tc_col() const { return colind_ ;}
